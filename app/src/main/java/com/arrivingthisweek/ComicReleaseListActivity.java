...
import com.arrivingthisweek.formatters.ComixologyDateFormatter;
import com.arrivingthisweek.formatters.DateFormatter;
...
public class ComicReleaseListActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    class ComicReleaseListAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int i) {
            ComicWebviewFragment fragment=null;
            if(i==0) {
                fragment = new ComicWebviewFragment();
                fragment.setUrl(dateFormatter.lastWeek());
            }
            if(i==1) {
                fragment=new ComicWebviewFragment();
                fragment.setUrl(dateFormatter.currentWeek());
            }
            if(i==2) {
                fragment=new ComicWebviewFragment();
                fragment.setUrl(dateFormatter.nextWeek());
            }
            return fragment;
        }
